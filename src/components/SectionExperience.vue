...
const IntrinsiQTasks = ["Developed cancer research survey in under 2 months that generated ~$4MM in revenue", "Implemented modular package pattern for consumption in various portals", "Migrated SCSS to Tailwind/CSS to leverage native browser CSS nesting"];
const QADTasks = [
	...
	"Maintained NestJS BFF endpoints, E2E tests, data mappers, and OpenAPI specifications",
];
</script>
