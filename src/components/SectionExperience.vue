...
const IntrinsiQTasks = [
	"Developed and maintained cancer research survey in 1 month that generated ~$4MM in revenue",
	"Participated in and lead meetings on migration of Medicare bill estimate software",
	"Built JSON Schema editing system for creating and validating against data contracts stored in Mongo",
	"Implemented modular package pattern for encapsulating various initiatives as plugins",
	"Migrated SCSS to Tailwind/CSS to leverage native browser CSS nesting",
];
const QADTasks = [
	...
	"Led biweekly web forums to discuss technical decisions and team roadblocks",
	"Introduced a local state management approach using Vue's provide/inject in place of Pinia",
	"Maintained NestJS Backend for Frontend endpoints, E2E tests, data mappers, and OpenAPI specifications",
];
</script>
...
<template>
  ...
  >
    ...
    <section class="flex flex-col space-y-3">
      ...
      >
        <template #tasks>
          ...
          <li>
            ...
            /> to improve productivity for creating greenfield applications
          </li>
          <li>
      ...
      <SectionJobDescription
        date-start="Mar 2023"
        project="Vue 3, TypeScript, Tailwind, Pinia, NestJS"
        company="QAD Redzone"
        location="Remote"
